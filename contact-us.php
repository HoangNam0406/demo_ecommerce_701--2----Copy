            ...
            <form method="post">
              <div class="form-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control rounded-0" rows="4" cols="4" name="message" required></textarea>
                </div>
                <div class="mb-0">
                  <button type="submit" name="send_message" class="btn btn-dark btn-ecomm">Send Message</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <div class="col-xl-4">
          <div class="p-3 border">
            <div class="address mb-3">
              ...
              <p class="mb-0 font-12">Nguyen Van Cu Streets, Can Tho City</p>
            </div>
            <hr>
            <div class="phone mb-3">
              <h5 class="mb-0 fw-bold">Phone</h5>
              <p class="mb-0 font-13">Toll Free (123) 472-796</p>
              <p class="mb-0 font-13">Mobile : +84 123456678</p>
            </div>
            <hr>
            <div class="email mb-3">
              <h5 class="mb-0 fw-bold">Email</h5>
              <p class="mb-0 font-13">ronaldo@gmail.com</p>
            </div>
            <hr>
            <div class="working-days mb-0">
              <h5 class="mb-0 fw-bold">Working Days</h5>
              <p class="mb-0 font-13">Mon - FRI / 9:00 AM - 8:00 PM</p>
            </div>
          </div>
        </div>
      </div>
