    ...
    <div class="row row-cols-1 row-cols-lg-4 g-4">
      <div class="col">
        <div class="footer-widget-6">
          ...
          <p class="mb-2">Soccer shoes are specially designed to meet the demands of the sport. We have a Gmail high-attention outsole, which makes it easy for players to switch and change direction suddenly on the field.
      ...
      <div class="col">
        <div class="footer-widget-7">
          ...
          <ul class="widget-link list-unstyled">
            ...
            <li><a href="javascript:;">Mizuno</a></li>
            <li><a href="javascript:;">Beyono</a></li>
      ...
      <div class="col">
        <div class="footer-widget-9">
          ...
          <div class="mb-4 mt-4">
            ...
            <p class="mb-0 text-muted">ronaldo@gmail.com</p>
          </div>
          <div class="">
            <h5 class="mb-0 fw-bold">Toll Free</h5>
            <p class="mb-0 text-muted">123456678</p>
          </div>
        </div>
      </div>
    </div><!--end row-->
